  ...
  return (
    <div className="pb-28 bg-soft-bg dark:bg-zinc-900 h-full">
      ...
      <div className="bg-soft-bg dark:bg-zinc-900 rounded-b-[40px] pt-[calc(env(safe-area-inset-top)+32px)] pb-16 px-6 text-zinc-900 dark:text-white shadow-primary z-10 geometric-bg relative">
         ...
         <p className="text-zinc-400 dark:text-zinc-500 mt-2 text-[13px] font-medium relative z-10 pr-10">
        ...
        <div className="bg-soft-bg dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl space-y-4 shadow-sm">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="number" step="0.01" value={settings.budget || ''} onChange={e => setSettings({...settings, budget: Number(e.target.value)})} placeholder="Ex: 500.00" className="w-full pl-10 pr-4 py-3.5 bg-zinc-100 dark:bg-zinc-800 border-none rounded-2xl ring-0 focus:ring-2 focus:ring-zinc-900 dark:ring-zinc-100 font-bold text-[16px] text-zinc-800 dark:text-zinc-200 placeholder-zinc-400" />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <button 
              ...
              className={`p-3 rounded-2xl transition-all ${settings.darkMode ? 'bg-zinc-800 text-white border border-zinc-700' : 'bg-zinc-100 text-zinc-500 border border-zinc-200'}`}
            >
