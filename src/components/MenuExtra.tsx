    ...
    <div className="pb-28 bg-soft-bg dark:bg-black min-h-screen">
      ...
      <div className="px-4 lg:px-6 -mt-8 relative z-20 flex flex-col space-y-5">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl shadow-sm text-center">
            <button onClick={handleShareList} className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 rounded-3xl transition-all active:scale-95 shadow-sm">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl space-y-4 shadow-sm">
          <h3 className="text-[11px] font-semibold uppercase tracking-widest text-emerald-600 dark:text-emerald-500 mb-2">Preferências de Compra</h3>
        ...
        {/* MEUS MERCADOS */}
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl space-y-4 shadow-sm">
          <h3 className="text-[11px] font-semibold uppercase tracking-widest text-emerald-600 dark:text-emerald-500 flex items-center gap-2">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl space-y-4 shadow-sm">
          ...
          {!hasHistory ? (
            ...
            <>
              {/* Gráfico Visual */}
              <div className="h-32 bg-zinc-50 dark:bg-zinc-800/50 rounded-3xl border border-zinc-100 dark:border-zinc-800 p-3 flex items-end gap-2 relative mt-4">
                ...
                {chartData.map(item => {
                   ...
                   return (
                     <div key={item.id} className="flex-1 flex flex-col items-center gap-1 z-10 relative group">
                        ...
                        <div 
                          className={`w-full rounded-t-lg transition-all ${isOver ? 'bg-red-400 dark:bg-red-500' : 'bg-gradient-to-br from-emerald-500 to-teal-400 dark:bg-emerald-500'}`}
              ...
              <div className="space-y-3 mt-4">
                {chartData.slice().reverse().map(item => {
                   ...
                   return (
                      <div key={item.id} className="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-3xl border border-zinc-100 dark:border-zinc-800">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-3xl shadow-sm">
          <button 
            ...
            className="w-full p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 transition-colors font-semibold rounded-3xl active:scale-95"
          >
